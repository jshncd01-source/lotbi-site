import {beginSiteHandoff, markSiteLogoutSuppression} from './site-auth.js?v=aset-8d44dcd95b16';
import * as siteCore from './site-core.js?v=aset-8d44dcd95b16';
import {buildGoogleMapsDirectionsUrl, buildKakaoNaviHandoffUrl, buildNaverMapsWebSearchUrl, buildVerifiedPhoneHref, isPlaceResultFresh, isTmapHandoffAvailable, normalizePlaceResult, openGoogleMapsPlace, openKakaoNaviPlace, openNaverMapsPlace, openTmapPlace} from './site-navigation.js?v=aset-8d44dcd95b16';
import * as siteAttachments from './site-attachments.js?v=aset-8d44dcd95b16';
import {formatConversationTimestamp, millisecondsUntilNextLocalMidnight, shouldShowConversationSeparator, timestampedConversationMessage} from './site-conversation-timeline.js?v=aset-8d44dcd95b16';
import {deterministicReply} from './site-deterministic.js?v=aset-8d44dcd95b16';
import {ensureDurableAnonymousConversationNamespace, guestConversationThreadClaimed, markConversationTabEntry, prepareGuestConversationClaimIntent} from './site-conversation-storage.js?v=aset-8d44dcd95b16';
import {executeLifeCalendarCommand, getLifeToday, isExplicitLifeCalendarCommand, previewLifeCalendarCommand} from './site-calendar.js?v=aset-8d44dcd95b16';
import {createGuestCalendarRepository} from './site-calendar-guest.js?v=aset-8d44dcd95b16';
import {calendarActionInFlight, createAvailableCalendarAction, normalizePersistedCalendarAction, recoverCalendarActionAfterReload, runCalendarAction} from './site-calendar-actions.js?v=aset-8d44dcd95b16';
import {CALENDAR_DRAFT_WRITE_STATE, registerCalendarDraft} from './site-calendar-draft-write.js?v=aset-8d44dcd95b16';
import {mountLifeCalendarManager} from './site-calendar-ui.js?v=aset-8d44dcd95b16';
import {createIconButton, createSafeMessageBody, enhanceExpandableUserMessage} from './site-message-body.js?v=aset-8d44dcd95b16';
import {createWakeListener, readWakePreference, stripWakePrefix, wakeListeningSupported, writeWakePreference} from './site-voice-wake.js?v=aset-8d44dcd95b16';
import {createThinkingPresentation, selectThinkingKind} from './site-chat-thinking.js?v=aset-8d44dcd95b16';
...
function ensureConversationStyles() {
  ...
  link.rel = 'stylesheet';
  link.href = '/site-conversation.css?v=aset-8d44dcd95b16';
...
function mountConversation({sessionToken: initialSessionToken, initialText = '', autoSend = false, identityKey = ''} = {}) {
      ...
      results: normalized.results.map(place => ({
        ...
        photo_evidence: place.photoEvidence ? {
          ...
          attributions: Array.isArray(place.photoEvidence.attributions)
            ? [...place.photoEvidence.attributions]
            : [],
        } : undefined,
        phone: place.phone,
  ...
  const openPetFamily = async (initialSurface = 'pets') => {
    ...
    try {
      ...
      const {mountPetFamilyManager} = await import('./site-pet-ui.js?v=aset-8d44dcd95b16');

Warning: truncated output (original token count: 57461)
Total output lines: 4297
...
import * as siteAttachments from './site-attachments.js?v=20260924-chatmedia3';
...
function ensureConversationStyles() {
  ...
  link.rel = 'stylesheet';
  link.href = '/site-conversation.css?v=20260924-chatmedia3';
...
function mountConversation({sessionToken: initialSessionToken, initialText = '', autoSend = false, identityKey = ''} = {}) {
  ...
  const createConversationCalendarDraft = draftValue => {
    ...
    const icon = document.createElement('span');
  …7461 tokens truncated…ttachments.length) meta.attachments = attachments;

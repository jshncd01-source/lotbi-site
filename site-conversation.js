import {beginSiteHandoff, markSiteLogoutSuppression} from './site-auth.js?v=aset-accae87fd3ec';
import * as siteCore from './site-core.js?v=aset-accae87fd3ec';
import {buildGoogleMapsDirectionsUrl, buildKakaoNaviHandoffUrl, buildNaverMapsWebSearchUrl, buildVerifiedPhoneHref, isPlaceResultFresh, isTmapHandoffAvailable, normalizePlaceResult, openGoogleMapsPlace, openKakaoNaviPlace, openNaverMapsPlace, openTmapPlace} from './site-navigation.js?v=aset-accae87fd3ec';
import * as siteAttachments from './site-attachments.js?v=aset-accae87fd3ec';
import {formatConversationTimestamp, millisecondsUntilNextLocalMidnight, shouldShowConversationSeparator, timestampedConversationMessage} from './site-conversation-timeline.js?v=aset-accae87fd3ec';
import {deterministicReply} from './site-deterministic.js?v=aset-accae87fd3ec';
import {ensureDurableAnonymousConversationNamespace, guestConversationThreadClaimed, markConversationTabEntry, prepareGuestConversationClaimIntent} from './site-conversation-storage.js?v=aset-accae87fd3ec';
import {executeLifeCalendarCommand, getLifeToday, isExplicitLifeCalendarCommand, previewLifeCalendarCommand} from './site-calendar.js?v=aset-accae87fd3ec';
import {createGuestCalendarRepository} from './site-calendar-guest.js?v=aset-accae87fd3ec';
import {calendarActionInFlight, createAvailableCalendarAction, normalizePersistedCalendarAction, recoverCalendarActionAfterReload, runCalendarAction} from './site-calendar-actions.js?v=aset-accae87fd3ec';
import {CALENDAR_DRAFT_WRITE_STATE, registerCalendarDraft} from './site-calendar-draft-write.js?v=aset-accae87fd3ec';
import {mountLifeCalendarManager} from './site-calendar-ui.js?v=aset-accae87fd3ec';
import {createIconButton, createSafeMessageBody, enhanceExpandableUserMessage} from './site-message-body.js?v=aset-accae87fd3ec';
import {createReusableOutputCard} from './site-output-card.js?v=aset-accae87fd3ec';
import {createWakeListener, readWakePreference, stripWakePrefix, wakeListeningSupported, writeWakePreference} from './site-voice-wake.js?v=aset-accae87fd3ec';
import {pickBestKoreanVoice, waitForVoices} from './site-voice-tts.js?v=aset-accae87fd3ec';
import {createThinkingPresentation, selectThinkingKind} from './site-chat-thinking.js?v=aset-accae87fd3ec';
...
function ensureConversationStyles() {
  ...
  link.rel = 'stylesheet';
  link.href = '/site-conversation.css?v=aset-accae87fd3ec';  link.dataset.siteConversationStyles = 'true';
...
function mountConversation({sessionToken: initialSessionToken, initialText = '', autoSend = false, identityKey = ''} = {}) {
  ...
  const openPetFamily = async (initialSurface = 'pets') => {
    ...
    try {
      ...
      const {mountPetFamilyManager} = await import('./site-pet-ui.js?v=aset-accae87fd3ec');      const mounted = await mountPetFamilyManager({
  ...
  const openFestival = async ({festivalId = '', selectedDate = ''} = {}) => {
    ...
    try {
      ...
      const {mountFestivalManager} = await import('./site-festival-ui.js?v=aset-accae87fd3ec');

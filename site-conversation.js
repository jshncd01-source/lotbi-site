import {beginSiteHandoff, markSiteLogoutSuppression} from './site-auth.js?v=aset-bb8131a1c21b';
import * as siteCore from './site-core.js?v=aset-bb8131a1c21b';
import {buildGoogleMapsDirectionsUrl, buildKakaoNaviHandoffUrl, buildNaverMapsWebSearchUrl, buildVerifiedPhoneHref, isPlaceResultFresh, isTmapHandoffAvailable, normalizePlaceResult, openGoogleMapsPlace, openKakaoNaviPlace, openNaverMapsPlace, openTmapPlace} from './site-navigation.js?v=aset-bb8131a1c21b';
import * as siteAttachments from './site-attachments.js?v=aset-bb8131a1c21b';
import {formatConversationTimestamp, millisecondsUntilNextLocalMidnight, shouldShowConversationSeparator, timestampedConversationMessage} from './site-conversation-timeline.js?v=aset-bb8131a1c21b';
import {deterministicReply} from './site-deterministic.js?v=aset-bb8131a1c21b';
import {ensureDurableAnonymousConversationNamespace, guestConversationThreadClaimed, markConversationTabEntry, prepareGuestConversationClaimIntent} from './site-conversation-storage.js?v=aset-bb8131a1c21b';
import {executeLifeCalendarCommand, getLifeToday, isExplicitLifeCalendarCommand, previewLifeCalendarCommand} from './site-calendar.js?v=aset-bb8131a1c21b';
import {createGuestCalendarRepository} from './site-calendar-guest.js?v=aset-bb8131a1c21b';
import {calendarActionInFlight, createAvailableCalendarAction, normalizePersistedCalendarAction, recoverCalendarActionAfterReload, runCalendarAction} from './site-calendar-actions.js?v=aset-bb8131a1c21b';
import {CALENDAR_DRAFT_WRITE_STATE, registerCalendarDraft} from './site-calendar-draft-write.js?v=aset-bb8131a1c21b';
import {mountLifeCalendarManager} from './site-calendar-ui.js?v=aset-bb8131a1c21b';
import {createIconButton, createSafeMessageBody, enhanceExpandableUserMessage} from './site-message-body.js?v=aset-bb8131a1c21b';
import {createReusableOutputCard} from './site-output-card.js?v=aset-bb8131a1c21b';
import {createWakeListener, readWakePreference, stripWakePrefix, wakeListeningSupported, writeWakePreference} from './site-voice-wake.js?v=aset-bb8131a1c21b';
import {pickBestKoreanVoice, waitForVoices} from './site-voice-tts.js?v=aset-bb8131a1c21b';
import {createThinkingPresentation, selectThinkingKind} from './site-chat-thinking.js?v=aset-bb8131a1c21b';
...
function ensureConversationStyles() {
  ...
  link.rel = 'stylesheet';
  link.href = '/site-conversation.css?v=aset-bb8131a1c21b';
...
function mountConversation({sessionToken: initialSessionToken, initialText = '', autoSend = false, identityKey = ''} = {}) {
  ...
  const openPetFamily = async (initialSurface = 'pets') => {
    ...
    try {
      ...
      const {mountPetFamilyManager} = await import('./site-pet-ui.js?v=aset-bb8131a1c21b');
  ...
  const openFestival = async ({festivalId = '', selectedDate = ''} = {}) => {
    ...
    try {
      ...
      const {mountFestivalManager} = await import('./site-festival-ui.js?v=aset-bb8131a1c21b');

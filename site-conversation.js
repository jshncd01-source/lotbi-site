import {beginSiteHandoff, markSiteLogoutSuppression} from './site-auth.js?v=aset-ce6e1c10499a';
import * as siteCore from './site-core.js?v=aset-ce6e1c10499a';
import {buildGoogleMapsDirectionsUrl, buildKakaoNaviHandoffUrl, buildNaverMapsWebSearchUrl, buildVerifiedPhoneHref, isPlaceResultFresh, isTmapHandoffAvailable, normalizePlaceResult, openGoogleMapsPlace, openKakaoNaviPlace, openNaverMapsPlace, openTmapPlace} from './site-navigation.js?v=aset-ce6e1c10499a';
import * as siteAttachments from './site-attachments.js?v=aset-ce6e1c10499a';
import {formatConversationTimestamp, millisecondsUntilNextLocalMidnight, shouldShowConversationSeparator, timestampedConversationMessage} from './site-conversation-timeline.js?v=aset-ce6e1c10499a';
import {deterministicReply} from './site-deterministic.js?v=aset-ce6e1c10499a';
import {ensureDurableAnonymousConversationNamespace, guestConversationThreadClaimed, markConversationTabEntry, prepareGuestConversationClaimIntent} from './site-conversation-storage.js?v=aset-ce6e1c10499a';
import {executeLifeCalendarCommand, getLifeToday, isExplicitLifeCalendarCommand, previewLifeCalendarCommand} from './site-calendar.js?v=aset-ce6e1c10499a';
import {createGuestCalendarRepository} from './site-calendar-guest.js?v=aset-ce6e1c10499a';
import {calendarActionInFlight, createAvailableCalendarAction, normalizePersistedCalendarAction, recoverCalendarActionAfterReload, runCalendarAction} from './site-calendar-actions.js?v=aset-ce6e1c10499a';
import {CALENDAR_DRAFT_WRITE_STATE, registerCalendarDraft} from './site-calendar-draft-write.js?v=aset-ce6e1c10499a';
import {mountLifeCalendarManager} from './site-calendar-ui.js?v=aset-ce6e1c10499a';
import {createIconButton, createSafeMessageBody, enhanceExpandableUserMessage} from './site-message-body.js?v=aset-ce6e1c10499a';
import {createReusableOutputCard} from './site-output-card.js?v=aset-ce6e1c10499a';
import {createWakeListener, readWakePreference, stripWakePrefix, wakeListeningSupported, writeWakePreference} from './site-voice-wake.js?v=aset-ce6e1c10499a';
import {pickBestKoreanVoice, waitForVoices} from './site-voice-tts.js?v=aset-ce6e1c10499a';
import {createThinkingPresentation, selectThinkingKind} from './site-chat-thinking.js?v=aset-ce6e1c10499a';
...
function ensureConversationStyles() {
  ...
  link.rel = 'stylesheet';
  link.href = '/site-conversation.css?v=aset-ce6e1c10499a';
...
function mountConversation({sessionToken: initialSessionToken, initialText = '', autoSend = false, identityKey = ''} = {}) {
  ...
  const openPetFamily = async (initialSurface = 'pets') => {
    ...
    try {
      ...
      const {mountPetFamilyManager} = await import('./site-pet-ui.js?v=aset-ce6e1c10499a');
  ...
  const openFestival = async () => {
    ...
    try {
      ...
      const {mountFestivalManager} = await import('./site-festival-ui.js?v=aset-ce6e1c10499a');

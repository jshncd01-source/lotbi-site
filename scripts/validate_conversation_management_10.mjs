...
assert.ok(index.includes('src="site-conversation.js?v=20260920-realcal2"'), 'Home must cache-bust PHASE 10 conversation runtime');
...
assert.ok(callbackHtml.includes('src="/auth-callback.js?v=20260920-realcal2"'), 'auth callback entry must be cache-busted for PHASE 10');
assert.ok(callbackJs.includes("from './site-conversation.js?v=20260920-realcal2'"), 'auth callback must import the PHASE 10 conversation runtime');

...
assert.ok(index.includes('src="site-conversation.js?v=20260921-convcalentry3"'), 'Home must cache-bust the combined conversation runtime');
...
assert.ok(callbackHtml.includes('src="/auth-callback.js?v=20260921-convcalentry3"'), 'auth callback entry must use the combined conversation cache key');
assert.ok(callbackJs.includes("from './site-conversation.js?v=20260921-convcalentry3'"), 'auth callback must import the combined conversation runtime');

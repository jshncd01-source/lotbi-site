...
assert.ok(index.includes('src="site-conversation.js?v=20260920-messageux1"'), 'Home must cache-bust the combined conversation runtime');
...
assert.ok(callbackJs.includes("from './site-conversation.js?v=20260920-messageux1'"), 'auth callback must import the combined conversation runtime');

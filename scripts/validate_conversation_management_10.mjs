...
assert.ok(index.includes('src="site-conversation.js?v=20260920-authux1"'), 'Home must cache-bust PHASE 10 conversation runtime');
...
assert.ok(callbackJs.includes("from './site-conversation.js?v=20260920-authux1'"), 'auth callback must import the PHASE 10 conversation runtime');

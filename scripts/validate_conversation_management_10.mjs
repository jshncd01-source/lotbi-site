...
assert.ok(index.includes('src="site-conversation.js?v=20260920-convcalentry1"'), 'Home must cache-bust the combined conversation runtime');
...
assert.ok(callbackHtml.includes('src="/auth-callback.js?v=20260920-convcalentry1"'), 'auth callback entry must use the combined conversation cache key');
assert.ok(callbackJs.includes("from './site-conversation.js?v=20260920-convcalentry1'"), 'auth callback must import the combined conversation runtime');

...
assert.ok(index.includes('src="site-conversation.js?v=20260920-lotbibox1"'), 'Home must cache-bust the current conversation runtime while preserving PHASE 10 behavior');

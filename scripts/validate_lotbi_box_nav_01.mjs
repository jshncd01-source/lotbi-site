...
assert.ok(html.includes('site-calendar.css?v=20260920-calux1'), 'real Calendar CSS must remain preserved');
assert.ok(html.includes('site-conversation.js?v=20260920-calendarentry5'), 'LOTBI Box must remain on the fresh combined conversation runtime');

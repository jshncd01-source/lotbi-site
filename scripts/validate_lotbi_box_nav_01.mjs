...
assert.ok(html.includes('site-calendar.css?v=20260921-convcal3'), 'real Calendar CSS must remain preserved');
assert.ok(html.includes('site-conversation.js?v=20260921-convcalentry3'), 'LOTBI Box must remain on the fresh combined conversation runtime');

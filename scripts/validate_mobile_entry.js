...
function run() {
  ...
  for (const excluded of [
    ...
    '/assets/lotbi-logo-official-color-727a1940b747.png',
    '/home-chat.css',
    '/home-shell.js',
    '/font.woff2',
    '/favicon.ico',
  ...
  assert.equal(entry.OFFICIAL_LOGO_SRC, '/assets/lotbi-logo-official-color-727a1940b747.png', 'chooser must use the authoritative LOTBI logo asset');
  ...
  assert.ok(!source.includes('lotbi-logo-official-color-d3b499fe546c.jpg'), 'JPEG cache-bust logo must not return to the chooser');

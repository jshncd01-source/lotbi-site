...
<link rel="stylesheet" href="/site-calendar.css?v=20260924-placecompact1">
...
try{
  ...
  const manager=await import('/site-calendar-manager.js?v=20260924-placecompact1');
  const weatherModule=await import('/site-calendar-weather.js?v=20260923-daysheet3');

...
assert.match(conversationSource, /site-navigation\.js\?v=20260924-mapdeeplink1/u);
...
assert.match(conversationSource, /site-conversation\.css\?v=[A-Za-z0-9._-]+/u);
...
assert.match(
  conversationSource,
  /\.\/site-navigation\.js\?v=20260924-mapdeeplink1/u,

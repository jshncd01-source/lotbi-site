...
assert.ok(syncBody.includes('clearSiteLogoutSuppression();') && syncBody.indexOf('if (!authenticated)') < syncBody.indexOf('clearSiteLogoutSuppression();'), 'confirmed anonymous Account state must clear the suppression marker');

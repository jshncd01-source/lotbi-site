...
assert.ok(index.includes('href="site-calendar.css?v=20260923-onelinebar1"'));
...
assert.ok(callback.includes('href="/site-calendar.css?v=20260923-onelinebar1"'));
...
assert.ok(ui.includes("from './site-calendar-manager.js?v=20260923-onelinebar1'"));

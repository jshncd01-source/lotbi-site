...

{
  ...
  // 주 시작 요일 setting can move the grid's first and last cell by up to six
  // days, and a range tied to one start would leave cells on screen that the
  // last read never asked for. So the window ends one day later than it used to.
...
assert.ok(index.includes('href="site-calendar.css?v=20260924-licensebadge1"'));
...
assert.ok(callback.includes('href="/site-calendar.css?v=20260924-licensebadge1"'));
...
assert.ok(ui.includes("from './site-calendar-manager.js?v=20260924-licensebadge1'"));

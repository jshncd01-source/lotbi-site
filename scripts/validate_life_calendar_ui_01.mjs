...
assert.ok(callbackJs.includes("import {mountLifeCalendarIfEnabled} from './site-calendar-ui.js?v=20260922-deleteconfirm1';"));
...
assert.ok(ui.includes("from './site-calendar-manager.js?v=20260922-deleteconfirm1'"));

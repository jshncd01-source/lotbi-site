...
assert.ok(index.includes('href="site-calendar.css?v=20260922-daysheet1"'));
...
assert.ok(callback.includes('href="/site-calendar.css?v=20260922-daysheet1"'));
...
assert.ok(ui.includes("from './site-calendar-manager.js?v=20260922-sessionfix1'"));

...
def main() -> int:
    ...
    requirements = {
        ...
        "approved conversation module": 'src="site-conversation.js?v=20260921-placecardflash1"',
        ...
        "calendar stylesheet": 'href="site-calendar.css?v=20260921-convcal2"',
    ...
    approved_scripts = (
        ...
        '<script type="module" src="site-conversation.js?v=20260921-placecardflash1"></script>',

...
network and persistence behavior. The approved mobile-entry.js bootstrap and
sealed Site Avatar runtime may coexist.
"""
...
def main() -> int:
    ...
    print("HOME CHAT VALIDATION PASS — sealed Avatar runtime, approved logo fit, simplified AI-service sidebar IA, recent-scroll/fixed-account layout, neutral auth continuity and composer contracts verified.")
    return 0

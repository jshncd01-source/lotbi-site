...
def main() -> int:
    ...
    requirements = {
        ...
        "approved conversation module": 'src="site-conversation.js?v=20260919-avatarflash1"',
    ...
    approved_scripts = (
        ...
        '<script type="module" src="site-conversation.js?v=20260919-avatarflash1"></script>',

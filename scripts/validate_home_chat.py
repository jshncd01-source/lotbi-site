...
def main() -> int:
    ...
    requirements = {
        ...
        "approved conversation module": 'src="site-conversation.js?v=20260920-calendarentry4"',
        ...
        "calendar stylesheet": 'href="site-calendar.css?v=20260920-calux1"',
    ...
    approved_scripts = (
        ...
        '<script type="module" src="site-conversation.js?v=20260920-calendarentry4"></script>',

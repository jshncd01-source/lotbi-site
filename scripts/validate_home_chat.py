...
def main() -> int:
    ...
    print("HOME CHAT VALIDATION PASS — approved logo fit, simplified AI-service sidebar IA, recent-scroll/fixed-account layout, neutral auth continuity and composer contracts verified.")
    return 0

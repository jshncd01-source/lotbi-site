...
def main() -> int:
    ...
    requirements = {
        ...
        "approved conversation module": 'src="site-conversation.js?v=20260921-convcalentry3"',
        ...
        "calendar stylesheet": 'href="site-calendar.css?v=20260921-convcal3"',
    ...
    approved_scripts = (
        ...
        '<script type="module" src="site-conversation.js?v=20260921-convcalentry3"></script>',

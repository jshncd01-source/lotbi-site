...
def main() -> int:
    ...
    requirements = {
        ...
        "approved conversation module": 'src="site-conversation.js?v=20260920-convcal1"',
        ...
        "calendar stylesheet": 'href="site-calendar.css?v=20260920-convcal1"',
    ...
    approved_scripts = (
        ...
        '<script type="module" src="site-conversation.js?v=20260920-convcal1"></script>',

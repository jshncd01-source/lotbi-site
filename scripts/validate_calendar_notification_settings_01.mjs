...
assert.match(conversation, /site-calendar-ui\.js\?v=20260923-daypanel2btn1/);
assert.match(index, /site-conversation\.js\?v=20260923-daypanel2btn1/);
assert.match(callback, /site-conversation\.js\?v=20260923-daypanel2btn1/);
assert.match(callbackHtml, /auth-callback\.js\?v=20260923-daypanel2btn1/);

...
assert.match(index, /site-conversation\.js\?v=20260923-themeauto2/);
assert.match(callback, /site-conversation\.js\?v=20260923-themeauto2/);
assert.match(callbackHtml, /auth-callback\.js\?v=20260923-themeauto2/);

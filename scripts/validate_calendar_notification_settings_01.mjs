...
assert.match(index, /site-conversation\.js\?v=20260923-wakematch1/);
assert.match(callback, /site-conversation\.js\?v=20260923-wakematch1/);
assert.match(callbackHtml, /auth-callback\.js\?v=20260923-wakematch1/);

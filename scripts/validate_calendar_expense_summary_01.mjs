...
<link rel="stylesheet" href="/site-calendar.css?v=20260923-othercat2">
...
try{
  ...
  const manager=await import('/site-calendar-manager.js?v=20260923-othercat2');
  ...
  {
    const expense=await import('/site-calendar-expense.js?v=20260923-othercat2');

...
<link rel="stylesheet" href="/site-calendar.css?v=20260920-calendarentry4">
...
try{
  localStorage.clear();
  const {createGuestCalendarRepository}=await import('/site-calendar-guest.js?v=20260920-calendarentry4');

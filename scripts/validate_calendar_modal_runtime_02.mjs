...
<link rel="stylesheet" href="/site-calendar.css?v=20260921-convcal3">
...
try{
  localStorage.clear();
  const {createGuestCalendarRepository}=await import('/site-calendar-guest.js?v=20260921-convcal3');
  ...
  const managerModule=await import('/site-calendar-manager.js?v=20260921-convcal3');

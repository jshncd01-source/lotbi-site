import {sampleClip,zero,smooth,validateControls} from './animation.mjs?v=aset-0a3d8dea936d';
import {speechEmphasis,easeSpeechMotionEnergy} from './speech-envelope.mjs?v=aset-0a3d8dea936d';
import {AvatarStateMachine} from './state-machine.mjs?v=aset-0a3d8dea936d';
import {deriveSpeechVariation,sampleSpeechVariation} from './speech-variation.mjs?v=aset-0a3d8dea936d';

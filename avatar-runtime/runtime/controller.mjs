import {sampleClip,zero,smooth,validateControls} from './animation.mjs?v=aset-f7fc5e9a8472';
import {speechEmphasis,easeSpeechMotionEnergy} from './speech-envelope.mjs?v=aset-f7fc5e9a8472';
import {AvatarStateMachine} from './state-machine.mjs?v=aset-f7fc5e9a8472';
import {deriveSpeechVariation,sampleSpeechVariation} from './speech-variation.mjs?v=aset-f7fc5e9a8472';

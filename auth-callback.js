...
} from './site-auth.js?v=aset-2a1829421468';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-2a1829421468';
import {mountConversation} from './site-conversation.js?v=aset-2a1829421468';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-2a1829421468';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-2a1829421468');
  await loadClassicScript('/mobile-entry.js?v=aset-2a1829421468');
}

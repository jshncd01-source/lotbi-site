...
} from './site-auth.js?v=aset-a8e6b3637394';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-a8e6b3637394';
import {mountConversation} from './site-conversation.js?v=aset-a8e6b3637394';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-a8e6b3637394';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-a8e6b3637394');
  await loadClassicScript('/mobile-entry.js?v=aset-a8e6b3637394');
}

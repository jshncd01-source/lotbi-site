...
} from './site-auth.js?v=aset-c4450fb313c4';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-c4450fb313c4';
import {mountConversation} from './site-conversation.js?v=aset-c4450fb313c4';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-c4450fb313c4';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-c4450fb313c4');
  await loadClassicScript('/mobile-entry.js?v=aset-c4450fb313c4');
}

...
} from './site-auth.js?v=aset-8290674cea99';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-8290674cea99';
import {mountConversation} from './site-conversation.js?v=aset-8290674cea99';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-8290674cea99';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-8290674cea99');
  await loadClassicScript('/mobile-entry.js?v=aset-8290674cea99');
}

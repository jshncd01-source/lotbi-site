...
} from './site-auth.js?v=aset-c6b1e0c8f05b';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-c6b1e0c8f05b';
import {mountConversation} from './site-conversation.js?v=aset-c6b1e0c8f05b';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-c6b1e0c8f05b';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-c6b1e0c8f05b');
  await loadClassicScript('/mobile-entry.js?v=aset-c6b1e0c8f05b');
}

...
} from './site-auth.js?v=aset-975b9c80ce29';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-975b9c80ce29';
import {mountConversation} from './site-conversation.js?v=aset-975b9c80ce29';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-975b9c80ce29';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-975b9c80ce29');
  await loadClassicScript('/mobile-entry.js?v=aset-975b9c80ce29');
}

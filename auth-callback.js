...
} from './site-auth.js?v=aset-03eb88035482';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-03eb88035482';
import {mountConversation} from './site-conversation.js?v=aset-03eb88035482';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-03eb88035482';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-03eb88035482');
  await loadClassicScript('/mobile-entry.js?v=aset-03eb88035482');
}

...
} from './site-auth.js?v=aset-cd9cb47a5f5e';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-cd9cb47a5f5e';
import {mountConversation} from './site-conversation.js?v=aset-cd9cb47a5f5e';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-cd9cb47a5f5e';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-cd9cb47a5f5e');
  await loadClassicScript('/mobile-entry.js?v=aset-cd9cb47a5f5e');
}

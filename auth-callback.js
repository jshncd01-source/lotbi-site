...
} from './site-auth.js?v=aset-ab33a97493b7';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-ab33a97493b7';
import {mountConversation} from './site-conversation.js?v=aset-ab33a97493b7';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-ab33a97493b7';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-ab33a97493b7');
  await loadClassicScript('/mobile-entry.js?v=aset-ab33a97493b7');
}

...
} from './site-auth.js?v=aset-3da93cec543f';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-3da93cec543f';
import {mountConversation} from './site-conversation.js?v=aset-3da93cec543f';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-3da93cec543f';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-3da93cec543f');
  await loadClassicScript('/mobile-entry.js?v=aset-3da93cec543f');
}

...
} from './site-auth.js?v=aset-8d44dcd95b16';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-8d44dcd95b16';
import {mountConversation} from './site-conversation.js?v=aset-8d44dcd95b16';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-8d44dcd95b16';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-8d44dcd95b16');
  await loadClassicScript('/mobile-entry.js?v=aset-8d44dcd95b16');
}

...
} from './site-auth.js?v=aset-9028778abb98';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-9028778abb98';
import {mountConversation} from './site-conversation.js?v=aset-9028778abb98';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-9028778abb98';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-9028778abb98');
  await loadClassicScript('/mobile-entry.js?v=aset-9028778abb98');
}

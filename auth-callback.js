...
} from './site-auth.js?v=aset-81c2d93709bd';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-81c2d93709bd';
import {mountConversation} from './site-conversation.js?v=aset-81c2d93709bd';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-81c2d93709bd';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-81c2d93709bd');
  await loadClassicScript('/mobile-entry.js?v=aset-81c2d93709bd');
}

...
} from './site-auth.js?v=aset-9d9140cd76ac';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-9d9140cd76ac';
import {mountConversation} from './site-conversation.js?v=aset-9d9140cd76ac';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-9d9140cd76ac';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-9d9140cd76ac');
  await loadClassicScript('/mobile-entry.js?v=aset-9d9140cd76ac');
}

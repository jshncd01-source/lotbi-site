...
} from './site-auth.js?v=aset-accae87fd3ec';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-accae87fd3ec';
import {mountConversation} from './site-conversation.js?v=aset-accae87fd3ec';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-accae87fd3ec';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-accae87fd3ec');
  await loadClassicScript('/mobile-entry.js?v=aset-accae87fd3ec');
}

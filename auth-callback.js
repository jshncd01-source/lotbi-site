...
} from './site-auth.js?v=aset-19a32133d76b';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-19a32133d76b';
import {mountConversation} from './site-conversation.js?v=aset-19a32133d76b';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-19a32133d76b';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-19a32133d76b');
  await loadClassicScript('/mobile-entry.js?v=aset-19a32133d76b');
}

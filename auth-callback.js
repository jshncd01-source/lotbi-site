...
} from './site-auth.js?v=aset-a2d974c2fcfd';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-a2d974c2fcfd';
import {mountConversation} from './site-conversation.js?v=aset-a2d974c2fcfd';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-a2d974c2fcfd';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-a2d974c2fcfd');
  await loadClassicScript('/mobile-entry.js?v=aset-a2d974c2fcfd');
}

...
} from './site-auth.js?v=aset-pending';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-pending';
import {mountConversation} from './site-conversation.js?v=aset-pending';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-pending';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-pending');
  await loadClassicScript('/mobile-entry.js?v=aset-pending');
}

...
} from './site-auth.js?v=aset-4def738f36a9';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-4def738f36a9';
import {mountConversation} from './site-conversation.js?v=aset-4def738f36a9';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-4def738f36a9';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-4def738f36a9');
  await loadClassicScript('/mobile-entry.js?v=aset-4def738f36a9');
}

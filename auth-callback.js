...
} from './site-auth.js?v=aset-77deb4d6ad10';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-77deb4d6ad10';
import {mountConversation} from './site-conversation.js?v=aset-77deb4d6ad10';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-77deb4d6ad10';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-77deb4d6ad10');
  await loadClassicScript('/mobile-entry.js?v=aset-77deb4d6ad10');
}

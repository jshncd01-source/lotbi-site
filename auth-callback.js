...
} from './site-auth.js?v=aset-6c31fddb37a5';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-6c31fddb37a5';
import {mountConversation} from './site-conversation.js?v=aset-6c31fddb37a5';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-6c31fddb37a5';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-6c31fddb37a5');
  await loadClassicScript('/mobile-entry.js?v=aset-6c31fddb37a5');
}

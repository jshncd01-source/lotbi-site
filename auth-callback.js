...
} from './site-auth.js?v=aset-2779261be7de';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-2779261be7de';
import {mountConversation} from './site-conversation.js?v=aset-2779261be7de';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-2779261be7de';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-2779261be7de');
  await loadClassicScript('/mobile-entry.js?v=aset-2779261be7de');
}

...
} from './site-auth.js?v=aset-af66d888b137';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-af66d888b137';
import {mountConversation} from './site-conversation.js?v=aset-af66d888b137';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-af66d888b137';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-af66d888b137');
  await loadClassicScript('/mobile-entry.js?v=aset-af66d888b137');
}

...
} from './site-auth.js?v=aset-6f9c7d5a6b67';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-6f9c7d5a6b67';
import {mountConversation} from './site-conversation.js?v=aset-6f9c7d5a6b67';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-6f9c7d5a6b67';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-6f9c7d5a6b67');
  await loadClassicScript('/mobile-entry.js?v=aset-6f9c7d5a6b67');
}

...
} from './site-auth.js?v=aset-fa32b58762d1';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-fa32b58762d1';
import {mountConversation} from './site-conversation.js?v=aset-fa32b58762d1';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-fa32b58762d1';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-fa32b58762d1');
  await loadClassicScript('/mobile-entry.js?v=aset-fa32b58762d1');
}

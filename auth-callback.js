...
} from './site-auth.js?v=aset-a8a5e6584e22';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-a8a5e6584e22';
import {mountConversation} from './site-conversation.js?v=aset-a8a5e6584e22';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-a8a5e6584e22';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-a8a5e6584e22');
  await loadClassicScript('/mobile-entry.js?v=aset-a8a5e6584e22');
}

...
} from './site-auth.js?v=aset-59f937b762d5';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-59f937b762d5';
import {mountConversation} from './site-conversation.js?v=aset-59f937b762d5';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-59f937b762d5';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-59f937b762d5');
  await loadClassicScript('/mobile-entry.js?v=aset-59f937b762d5');
}

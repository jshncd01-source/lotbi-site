...
} from './site-auth.js?v=aset-625724e05994';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-625724e05994';
import {mountConversation} from './site-conversation.js?v=aset-625724e05994';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-625724e05994';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-625724e05994');
  await loadClassicScript('/mobile-entry.js?v=aset-625724e05994');
}

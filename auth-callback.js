...
} from './site-auth.js?v=aset-2f82dac3fda2';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-2f82dac3fda2';
import {mountConversation} from './site-conversation.js?v=aset-2f82dac3fda2';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-2f82dac3fda2';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-2f82dac3fda2');
  await loadClassicScript('/mobile-entry.js?v=aset-2f82dac3fda2');
}

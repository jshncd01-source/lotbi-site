...
} from './site-auth.js?v=aset-bc1900b95b20';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-bc1900b95b20';
import {mountConversation} from './site-conversation.js?v=aset-bc1900b95b20';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-bc1900b95b20';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-bc1900b95b20');
  await loadClassicScript('/mobile-entry.js?v=aset-bc1900b95b20');
}

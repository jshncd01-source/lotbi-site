...
} from './site-auth.js?v=aset-7db3f5c4ae8d';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-7db3f5c4ae8d';
import {mountConversation} from './site-conversation.js?v=aset-7db3f5c4ae8d';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-7db3f5c4ae8d';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-7db3f5c4ae8d');
  await loadClassicScript('/mobile-entry.js?v=aset-7db3f5c4ae8d');
}

...
} from './site-auth.js?v=aset-0121bef98c45';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-0121bef98c45';
import {mountConversation} from './site-conversation.js?v=aset-0121bef98c45';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-0121bef98c45';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-0121bef98c45');
  await loadClassicScript('/mobile-entry.js?v=aset-0121bef98c45');
}

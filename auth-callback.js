...
} from './site-auth.js?v=aset-a4b398cbf870';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-a4b398cbf870';
import {mountConversation} from './site-conversation.js?v=aset-a4b398cbf870';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-a4b398cbf870';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-a4b398cbf870');
  await loadClassicScript('/mobile-entry.js?v=aset-a4b398cbf870');
}

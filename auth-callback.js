...
} from './site-auth.js?v=aset-507a59068efd';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-507a59068efd';
import {mountConversation} from './site-conversation.js?v=aset-507a59068efd';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-507a59068efd';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-507a59068efd');
  await loadClassicScript('/mobile-entry.js?v=aset-507a59068efd');
}

...
} from './site-auth.js?v=aset-3de014d32463';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-3de014d32463';
import {mountConversation} from './site-conversation.js?v=aset-3de014d32463';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-3de014d32463';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-3de014d32463');
  await loadClassicScript('/mobile-entry.js?v=aset-3de014d32463');
}

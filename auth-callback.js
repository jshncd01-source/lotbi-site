...
} from './site-auth.js?v=aset-9a0b76d10736';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-9a0b76d10736';
import {mountConversation} from './site-conversation.js?v=aset-9a0b76d10736';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-9a0b76d10736';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-9a0b76d10736');
  await loadClassicScript('/mobile-entry.js?v=aset-9a0b76d10736');
}

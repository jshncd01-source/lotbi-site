...
} from './site-auth.js?v=aset-2aec97f675fa';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-2aec97f675fa';
import {mountConversation} from './site-conversation.js?v=aset-2aec97f675fa';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-2aec97f675fa';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-2aec97f675fa');
  await loadClassicScript('/mobile-entry.js?v=aset-2aec97f675fa');
}

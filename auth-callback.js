...
} from './site-auth.js?v=aset-60d7eb10da79';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-60d7eb10da79';
import {mountConversation} from './site-conversation.js?v=aset-60d7eb10da79';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-60d7eb10da79';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-60d7eb10da79');
  await loadClassicScript('/mobile-entry.js?v=aset-60d7eb10da79');
}

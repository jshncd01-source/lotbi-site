...
} from './site-auth.js?v=aset-cf022f054579';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-cf022f054579';
import {mountConversation} from './site-conversation.js?v=aset-cf022f054579';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-cf022f054579';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-cf022f054579');
  await loadClassicScript('/mobile-entry.js?v=aset-cf022f054579');
}

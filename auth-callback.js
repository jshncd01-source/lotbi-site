...
} from './site-auth.js?v=aset-cdfb642c3b79';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-cdfb642c3b79';
import {mountConversation} from './site-conversation.js?v=aset-cdfb642c3b79';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-cdfb642c3b79';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-cdfb642c3b79');
  await loadClassicScript('/mobile-entry.js?v=aset-cdfb642c3b79');
}

...
} from './site-auth.js?v=aset-0600df240b82';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-0600df240b82';
import {mountConversation} from './site-conversation.js?v=aset-0600df240b82';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-0600df240b82';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-0600df240b82');
  await loadClassicScript('/mobile-entry.js?v=aset-0600df240b82');
}

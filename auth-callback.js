...
} from './site-auth.js?v=aset-896d6fb3a184';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-896d6fb3a184';
import {mountConversation} from './site-conversation.js?v=aset-896d6fb3a184';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-896d6fb3a184';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-896d6fb3a184');
  await loadClassicScript('/mobile-entry.js?v=aset-896d6fb3a184');
}

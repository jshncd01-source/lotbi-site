...
} from './site-auth.js?v=aset-8e0b72122090';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-8e0b72122090';
import {mountConversation} from './site-conversation.js?v=aset-8e0b72122090';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-8e0b72122090';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-8e0b72122090');
  await loadClassicScript('/mobile-entry.js?v=aset-8e0b72122090');
}

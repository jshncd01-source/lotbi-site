...
} from './site-auth.js?v=aset-0a3d8dea936d';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-0a3d8dea936d';
import {mountConversation} from './site-conversation.js?v=aset-0a3d8dea936d';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-0a3d8dea936d';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-0a3d8dea936d');
  await loadClassicScript('/mobile-entry.js?v=aset-0a3d8dea936d');
}

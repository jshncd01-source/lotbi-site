...
} from './site-auth.js?v=aset-7e0aa3840b49';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-7e0aa3840b49';
import {mountConversation} from './site-conversation.js?v=aset-7e0aa3840b49';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-7e0aa3840b49';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-7e0aa3840b49');
  await loadClassicScript('/mobile-entry.js?v=aset-7e0aa3840b49');
}

...
} from './site-auth.js?v=aset-424e8c60ba13';
import {redeemSiteHandoff, SiteCoreError} from './site-core.js?v=aset-424e8c60ba13';
import {mountConversation} from './site-conversation.js?v=aset-424e8c60ba13';
import {claimGuestConversationToAccount} from './site-conversation-storage.js?v=aset-424e8c60ba13';
...
async function hydrateHomeShell() {
  ...
  await loadClassicScript('/home-shell.js?v=aset-424e8c60ba13');
  await loadClassicScript('/mobile-entry.js?v=aset-424e8c60ba13');
}
